  ...
  const sidebar = new Sidebar({
    ...
    menuItems: [
      ...
      },
      {
        id: 'nhacungcap',
        label: 'Nhà cung cấp',
        icon: `<svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor"><path d="M3 3a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H3zm1 2h12v10H4V5z"/><path d="M6 7h8v1H6V7zm0 2h8v1H6V9zm0 2h5v1H6v-1z"/></svg>`,
